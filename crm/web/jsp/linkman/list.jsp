...
<BODY>
<form action="${pageContext.request.contextPath}/linkMan_findAll.action" method="post" id="customerForm" name="customerForm">
					...
					<TR>
						<TD height=25>
							<TABLE cellSpacing=0 cellPadding=2 border=0>
								...
								<TR>
									<TD>联系人名称：</TD>
									<td><s:textfield name="lkm_name" cssClass="textbox" cssStyle="WIDTH:80px" maxLength="50" theme="simple"/></td>

									<TD>性别：</TD>
									<td><s:select name="lkm_gender" list="#{'1':'男','2':'女'}"  headerKey="" headerValue="-请选择-" theme="simple"/></td>
